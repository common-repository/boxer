...
<!DOCTYPE html>
<head>
    <title>Slider Content Wizard</title>
...
<body>
    <form class="form-horizontal">
        ...
        <div class="control-group">                
            ...
            <div class="controls">
                <select id="theme">
                    <?php $themes = array("default", "orman", "pascal"); ?>
        ...
        <div class="control-group">
            <label class="control-label" for="font_size">Caption Font Size</label>
            <div class="controls">
                <input type="text" class="input-small" id="font_size" placeholder="15"><span> px</span>
            </div>
        </div>
